...
AboutDialog::AboutDialog(QWidget *parent) : QDialog(parent)
{
    ...
    this->setWindowTitle(tr("About SerialPlus"));

    QLabel *developer=new QLabel(this);
    developer->setText(tr("<b>SerialPlus</b> was developed by"
                          "<p> Mohamed Hussein"
                          "<p> Feb,2017"));
    ...
    license->setText(tr("<b>SerialPlus</b> was distributed "
